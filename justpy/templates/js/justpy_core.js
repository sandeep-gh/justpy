...
class JustpyCore {
     ...
     */
  createApp1() {
   app1 = new jpComponentBuilder.App({
    ...
    handleMessageEvent(event) {
        ...
        switch (msg.type) {
          ...
          console.log("component_replace called");
                break;
            case 'run_javascript':
    ...
    handlePageUpdateEvent(msg){
      ...
      console.log("in handle page update event");
      console.log(msg.data);
      //app1.justpyComponents = msg.data;
      app1.$set({justpyComponents : msg.data});
      console.log(app1);
      console.log(app1.justpyComponents);
      console.log("done: in handle page update event");
